...
STATIC_LIB := $(OBJ_DIR)/libwatertightness.a
...
all: $(STATIC_LIB)
	...
	@ mv build/lib.linux-x86_64-3.7/watertightness ..
	@ mv build/lib.linux-x86_64-3.7/*.so ../watertightness/
...
clean:
	@- $(RM) -rf $(OBJ_DIR) build dist ./Watertight
